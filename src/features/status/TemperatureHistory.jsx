...
export default function TemperatureHistory() {
  ...
  const [step, setStep] = useState(5); // minutos
  const { data, loading, reload } = useTemperatureHistory({ range, step });
  ...
  return (
    <div>
      <div className="toolbar">
        ...
        <div className="muted">Lecturas {step}m • Rango ideal 20–26°C</div>
      </div>
